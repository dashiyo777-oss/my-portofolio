...
- [`knowledge/literary-essay-craft.md`](knowledge/literary-essay-craft.md) — 文学的エッセイ（随筆）の型。コンテスト・受賞作を狙う短編エッセイ用（場面から入る / 象徴を一本通す / 迷いを正直に / 実話厳守・AI出力そのまま応募しない / 提出前チェックリスト）。エッセイ・随筆・作文コンテストを書く／編集するタスクでは必ず参照する。
