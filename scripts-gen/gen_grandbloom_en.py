...
CSS = r"""
  *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
  ...
  body{font-family:'Cormorant Garamond',Georgia,'Times New Roman',serif;color:var(--white);display:flex;align-items:center;justify-content:center}
  ...
  .kicker{font-family:'Montserrat',system-ui,sans-serif;font-size:32px;letter-spacing:.42em;color:var(--gold);font-weight:600;margin-bottom:40px}
  ...
  .badge{display:inline-block;font-family:'Montserrat',system-ui,sans-serif;font-size:32px;letter-spacing:.2em;color:var(--bg-dark);
  ...
  .how{font-family:'Montserrat',system-ui,sans-serif;margin-top:46px;font-size:30px;color:var(--gray);letter-spacing:.05em}
  ...
  .cta-jp{font-family:'Montserrat',system-ui,sans-serif;font-size:36px;color:var(--gold);margin-top:20px;letter-spacing:.16em}
  .cta-sub{font-size:46px;color:var(--gray);margin-top:34px}
  .cta-url{margin-top:56px;font-family:'Montserrat',system-ui,sans-serif;font-size:46px;color:var(--white);border:2px solid var(--gold);
    border-radius:100px;padding:22px 56px;letter-spacing:.04em;background:rgba(214,154,42,.08)}
  .cta-free{font-family:'Montserrat',system-ui,sans-serif;margin-top:30px;font-size:38px;color:var(--gray);letter-spacing:.1em}
  #credit{position:absolute;left:0;right:0;top:70px;text-align:center;font-family:'Montserrat',system-ui,sans-serif;
  ...
  #ui .kick{font-family:'Montserrat',system-ui,sans-serif;font-size:32px;letter-spacing:.42em;color:var(--gold)}
  #ui h1{font-size:92px;font-weight:700;color:var(--white);line-height:1.15}
  #ui p{font-size:38px;color:var(--gray);line-height:1.6}
  #ui .song{font-family:'Montserrat',system-ui,sans-serif;font-size:30px;color:var(--amber)}
  #play{font-family:'Montserrat',system-ui,sans-serif;font-size:46px;font-weight:700;color:#1a1207;background:var(--gold);border:none;
...
def cta():
    return ('<div class="scene"><div class="cta-title">SAE Techo</div>'
            '<div class="cta-jp">Brain Dojo &nbsp;|&nbsp; Hana-Awase</div>'
            '<div class="cta-sub">Play hanafuda, and your mind sharpens</div>'
            '<div class="cta-url">ryuzaburo7.itch.io/sae-techo</div>'
            '<div class="cta-free">&#9654; Play free</div></div>')

scenes = [
    (4200, hook('With every card,<br>a <span class="glow">season blooms</span>.')),
    (3400, badge('SAE Techo — Brain Dojo', 'Hana-Awase')),
    (5000, card('Beautiful cards', 'Four seasons', 'The flowers of the seasons,<br>in your hand.', 'Japanese art to enjoy', jade=True)),
    (5000, card('Simple rules', 'Build yaku', 'Form combos,<br>score points.', 'Easy from your first game')),
    (5000, card('World Rankings', '&ldquo;Best bloom&rdquo;', 'Take your best bloom<br>to the world.', 'Chase the Hana-Awase record', jade=True)),
    (3200, names('Beautiful cards,<br>combos to build —', 'play, and your<br>mind sharpens.')),
    (4200, cta()),
]

meta = dict(
  title="Hana-Awase | SAE Techo (Promo Short — The Grand Bloom)",
  desc="The flowers of the seasons in your hand. Play hanafuda and sharpen your mind. SAE Techo. Music: The Grand Bloom / Maron",
  kicker="SAE Techo", ep="Hana-Awase", tagline="Play hanafuda, and your mind sharpens.",
  song="&#9834; The Grand Bloom / Maron")
...
<audio id="bgm" src="grand-bloom-maron-bgm.mp3" preload="auto"></audio>
<script>{engine}</script>
</body>
</html>
"""
open(os.path.join(OUT_DIR, "grand-bloom-maron-en.html"), "w", encoding="utf-8").write(html)
print(f"wrote grand-bloom-maron-en.html  ({sum(d for d,_ in scenes)/1000:.1f}s, {len(scenes)} scenes)")
